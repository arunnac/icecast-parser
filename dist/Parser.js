...
class Parser extends events_1.EventEmitter {
    ...
    makeRequest() {
        const request = this.options.url.startsWith('https://')
            ? https_1.default.request(this.options.url)
            : http_1.default.request(this.options.url);
        request.setHeader('Icy-MetaData', '1');
        Object.keys(this.options.additionalHeaders).forEach((prop) => request.setHeader(prop, this.options.additionalHeaders[prop]));
